...
num = input('Введите трехзначное положительное число: ')
...
k = 4 * p
s = p
print(f'Петя сделал {p} журавликов \nКатя сделала {k} журавликов \nСережа сделал {s} журавликов')
...
if int(num[0]) + int(num[1]) + int(num[2]) == int(num[3]) + int(num[4]) + int(
        num[5]):
